...
Remockable currently includes support for all of the Active Model validations,
and also supports the have_column, have_index, and have_scope Active Record
matchers.
...
Copyright (c) 2010-2011 Tyler Hunt. See LICENSE for details.
